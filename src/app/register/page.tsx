    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-black via-gray-900 to-black flex-col justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute top-1/3 right-10 w-16 h-16 bg-yellow-500 rounded-full animate-bounce"></div>
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-md mx-auto leading-relaxed">
            Crea tu cuenta y accede a diseños exclusivos, colecciones especiales 
            y personalización única para tu estilo.
          </p>
        ...
        <div className="absolute bottom-10 left-10 right-10 text-center">
          <p className="text-gray-400 italic">
            "Crea tu cuenta y personaliza tu mundo"
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <p className="text-gray-600 mb-8">
              Regístrate y comienza a personalizar tu estilo
            </p>
